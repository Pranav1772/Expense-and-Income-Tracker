...
const validateField = (field, feedbackArea, url, fieldName) => {
    field.addEventListener("keyup", (e) => {
        ...
        signupBtn.disabled = !(usernameField.value && emailField.value && passwordField.value);
...
validateField(usernameField, usernameFeedbackArea, "/spendsmart/authentication/validate-username/", "username");
validateField(emailField, emailFeedbackArea, "/spendsmart/authentication/validate-email/", "email");
